    ...
    <el-container>
      <div class="w-[90%] mx-auto">
        ...
        <div class="text-center mb-8">
          ...
          <p>
            Our model performs exceptionally well in Process Adherence and
            Efficiency during complex mediation. Unlike other models that act
            reactively and deviate from necessary conversational flow, it
            proactively executes the mediation strategy learned from the
            three-stage training paradigm, delivering better outcomes. In
            Condition 2 (with procedure in the prompt), it still maintains a
            lead with outstanding Process Adherence and achieves the highest
            outcome, as it effectively applies the procedure to resolve
            disputes. In direct comparisons, it consistently outperforms other
            models, with core strengths in maintaining structural integrity,
            factual accuracy, and procedural correctness throughout
            dialogues—reflected in near-perfect Impartiality and Clarity.
          </p>
        </div>
