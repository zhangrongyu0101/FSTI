<template>
  <footer class="bg-[#264653] text-white pt-16 pb-8 px-4">
    <el-container>
      <el-main>
        <div class="grid lg:grid-cols-2 md:grid-cols-2 sm:grid-cols-1 gap-12">
          <div>
            <div class="flex items-center mb-6">
              <div
                class="w-10 h-10 bg-[#2a9d8f] rounded-lg flex items-center justify-center mr-3"
              >
                <el-icon size="24" class="text-white">
                  <DocumentIcon />
                </el-icon>
              </div>
              <h3 class="text-xl font-bold">法智调</h3>
            </div>
            <p class="text-gray-400 mb-6">
              面向法院调解场景的智能助手系统，为金融纠纷提供公平、公正、高效的解决方案。
            </p>
          ...
          <div>
            ...
            <div class="grid grid-cols-1 gap-4 items-center">
              ...
              <NuxtLink to="https://huggingface.co" target="_blank">
                <div class="flex items-center space-x-2">
                  <el-icon size="36">
                    ...
                    >
                      ...
                      ></path>
                      <path
                        d="M589.397 828.288c-23.978-36.053-22.314-63.147 10.667-96.768 32.896-33.621 52.053-82.987 52.053-82.987s7.211-28.586 23.595-25.856c16.213 2.646 28.16 45.312-5.93 71.467-34.22 26.155 6.826 43.904 19.968 19.37 13.227-24.533 49.152-87.637 67.755-99.797 18.56-12.032-31.744-5.333 27.306 19.627-4.352 24.917-82.218 85.248-74.624 98.176 7.51 13.141 34.219-15.232 34.219-15.232s83.627-77.739 101.76-57.472c18.133 20.224-13.781 37.205-59.35 65.408 45.653 28.16 49.237 35.67 42.751 46.379-6.528 10.709 107.178-76.118 116.565-39.254 9.43 36.694-102.613 47.318-95.701 72.747 6.954 25.43 78.933-48.043 93.696-19.456 14.762 28.63-101.675 62.293-102.614 62.55-37.632 9.983-133.162 31.146-166.528-18.902z"
                        fill="#FFD21E"
                        p-id="5304"
                      ></path></svg
                  ></el-icon>
              ...
              <NuxtLink to="https://openreview.net" target="_blank">
                <div>
                  <p>OpenReview</p>
                </div>
              </NuxtLink>
        ...
        <div class="border-gray-800 pt-8">
          <div class="flex flex-col md:flex-row justify-between items-center">
            <p class="text-gray-500 text-sm mb-4 md:mb-0">
              &copy; 2025 法智调. 保留所有权利.
            </p>
