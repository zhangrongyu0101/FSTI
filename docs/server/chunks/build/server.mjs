import process from 'node:process';globalThis._importMeta_=globalThis._importMeta_||{url:"file:///_entry.js",env:process.env};import { getCurrentInstance, onMounted, nextTick, inject, computed, unref, ref, readonly, getCurrentScope, onScopeDispose, shallowRef, watchEffect, hasInjectionContext, defineComponent, h, Suspense, Fragment, createApp, provide, shallowReactive, toRef, onErrorCaptured, onServerPrefetch, createVNode, resolveDynamicComponent, reactive, effectScope, isReadonly, isRef, isShallow, isReactive, toRaw, defineAsyncComponent, mergeProps, useSSRContext } from 'vue';
import { w as withQuery, h as hasProtocol, l as isScriptProtocol, i as joinURL, s as sanitizeStatusCode, m as getContext, $ as $fetch, n as createHooks, o as executeAsync, c as createError$1, t as toRouteMatcher, p as createRouter$1, q as defu } from '../nitro/nitro.mjs';
...
const unhead_YkjPMPMeg40gvwhfPqUsDMJXDGY__63StHRLl8Mg2B8 = /* @__PURE__ */ defineNuxtPlugin({
  name: "nuxt:head",
  enforce: "pre",
  setup(nuxtApp) {
...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import('./index-CsvzVQMt.mjs')
  }
];
...
const revive_payload_server_fl8D1zZHryytVClUjnDLP6RQchiseDyF2_F1MDW5Vwo = /* @__PURE__ */ defineNuxtPlugin({
...
const plugins = [
  unhead_YkjPMPMeg40gvwhfPqUsDMJXDGY__63StHRLl8Mg2B8,
  plugin,
  revive_payload_server_fl8D1zZHryytVClUjnDLP6RQchiseDyF2_F1MDW5Vwo,
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-nE6R7VIt.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-Bs4lMPxF.mjs'));
...
_sfc_main$1.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/nuxt@4.1.2_@parcel+watcher@2.5.1_@vue+compiler-sfc@3.5.22_better-sqlite3@12.4.1_db0@0.3_a28a50b5994ad83a332a39e7b628426d/node_modules/nuxt/dist/app/components/nuxt-error-page.vue");
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/nuxt@4.1.2_@parcel+watcher@2.5.1_@vue+compiler-sfc@3.5.22_better-sqlite3@12.4.1_db0@0.3_a28a50b5994ad83a332a39e7b628426d/node_modules/nuxt/dist/app/components/nuxt-root.vue");
...
export { resolveRouteObject as A, useRuntimeConfig as B, navigateTo as C, nuxtLinkDefaults as D, _export_sfc as _, tryOnMounted as a, identity as b, useNamespace as c, isNumber as d, entry$1 as default, isStringNumber as e, isUndefined as f, isClient as g, isNil as h, isString as i, isBoolean as j, clamp as k, useZIndex as l, useId as m, noop as n, defaultNamespace as o, useTimeoutFn as p, useGetDerivedNamespace as q, resolveUnref as r, shared_cjs_prodExports as s, tryOnScopeDispose as t, useNuxtApp as u, useIdInjection as v, computedEager as w, isElement as x, isPropAbsent as y, useRouter as z };
